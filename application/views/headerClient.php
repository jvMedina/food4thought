...
<html>
  <head>
	...
	<script src="<?php echo base_url();?>public/js/jquerybootstrap.js"></script>
	   <script src="https://maps.googleapis.com/maps/api/js?v=3.16&libraries=places&sensor=false"></script>
	</head>
	<body>
		<nav class="navbar navbar-inverse navbar-fixed-top " role="navigation" style="margin-bottom:30px;">
			  <div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" id="nameLog" href="<?php echo base_url();?>index.php/client/index">food4thought</a>
					</div>
					<div id="navbar" class="navbar-collapse collapse pull-right">
						  <ul class="nav navbar-nav">
						  <?php echo $this->globals->clientAdmin($this->uri->segment(2));?>
						  <li><a href="<?php echo base_url();?>index.php/client/logout">Logout</a></li>
